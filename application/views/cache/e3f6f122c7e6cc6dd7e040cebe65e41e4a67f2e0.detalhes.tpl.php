...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_5501fe9dcbfdb5_02035008',
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5501fe9dcbfdb5_02035008')) {function content_5501fe9dcbfdb5_02035008($_smarty_tpl) {?><!DOCTYPE HTML>
<html lang="pt-br">
    <head>
        <!-- Define Charset -->
        <meta charset="utf-8">
...
<section class="container">
    <div class="row">
        <div class="col-lg-12">
            <h1 style="font-weight: 400;font-size: 3.2rem;margin-bottom: 16px;"><strong>Uno Mille</strong> 2014/2013</h1>
        </div>
    </div>
</section>
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="veiculo-slider flexslider">
                <ul class="slides">
                                                                        <li><img src="http://motors.designlab.com.br/web-files/upload/thumbs/DB45920322C0183DE83182E38CFCF206/43072E0059A5E1CE736ED9C11D40006C.jpg" /></li>
                                                                                                        <li><img src="http://motors.designlab.com.br/web-files/upload/thumbs/C3C9AC5E791AABC7EEDD8C1F698AF6B4/C6A161C99C726A0286B717264B011DE1.jpg" /></li>
                                                                                                        <li><img src="http://motors.designlab.com.br/web-files/upload/thumbs/00F4D45BB9791D7816F1BCB285240039/2981FB5BC72573BC250FDCA3D5B80B80.jpg" /></li>
                                                                    </ul>
            </div>
            <div class="veiculo-carousel flexslider">
                <ul class="slides">
                                                                        <li style="margin-right: 10px"><img src="http://motors.designlab.com.br/web-files/upload/thumbs/E49C3899368D03226E022ABE378595E9/ED04407E510846E02C891A32E1E73236.jpg" /></li>
                                                                                                        <li style="margin-right: 10px"><img src="http://motors.designlab.com.br/web-files/upload/thumbs/11BED69D0FC2BE81CD4CE9E2407338CA/BD85CE12FF4D239FDA8EBCBC4221A62A.jpg" /></li>
                                                                                                        <li style="margin-right: 10px"><img src="http://motors.designlab.com.br/web-files/upload/thumbs/3D5152CE4668364B1C4A21543BD634C5/E39D81EF8C056DC73B47781B4884D45B.jpg" /></li>
                                                                    </ul>
            </div>
        </div>
        <div class="col-md-4">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <p style='line-height: 2.2em;'>Estrada São Mateus, 111<br>
                            
                        Jardim Primavera<br />
                        Duque de Caxias/RJ<br />
                        CEP: 25215-283</p>
                    <p><a href="" style="font-size: 24px;letter-spacing: 0.04rem;font-weight: bold">+1 (321) 252-2323</a><p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row veiculo-info-panel">
            <div class="col col-sm-2 col-sm-offset-1">
                <p class="text-center">Ano<br>
                    <strong class="info-destaque">2014/2013</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Km<br>
                    <strong class="info-destaque">10</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Cor<br>
                    <strong class="info-destaque">cinza</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Câmbio<br>
                    <strong class="info-destaque">Manual</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Portas<br>
                    <strong class="info-destaque">5</strong>
                </p>
            </div>
        </div>
    </div>
