        ...
        <div class="row veiculo-info-panel">
            <div class="col col-sm-2 col-sm-offset-1">
                <p class="text-center">Ano<br>
                    <strong>{if $carro->ANO != 'Array'}{$carro->ANO}{/if}</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Km<br>
                    <strong>{if $carro->KM != 'Array'}{$carro->KM}{/if}</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Cor<br>
                    <strong>{if $carro->COR != 'Array'}{$carro->COR}{/if}</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Câmbio<br>
                    <strong>{if $carro->CAMBIO != 'Array'}{$carro->CAMBIO}{/if}</strong>
                </p>
            </div>
            <div class="col col-sm-2">
                <p class="text-center">Portas<br>
                    <strong>{if $carro->PORTAS != 'Array'}{$carro->PORTAS}{/if}</strong>
                </p>
            </div>
        </div>
    </div>
